...
Your \marginnote{-0.1in}{Evaluation Weights \\ Project Reports: 40\% \\ Final Project: 30\% \\ Final Exam: 30\%} course score will be calculated as a weighted average of the scores you earn on evaluation of the project reports ($40\%$), final project ($30\%$), and final exam ($30\%$). 
%
% --- LETTER GRADE ---
%
