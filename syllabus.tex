%----------------------------------------------------------------------------
% Course Syllabus for Chemistry 352 (c) 2017 by Dale J. Brugh
...
\makeoddhead{courseinformation}%
    {\sffamily Course Syllabus: Chemistry 352 / Spring 2017}{}{\sffamily\thepage}
...
During \marginnote{-0.1in}{All projects are completed as part of an assigned team.} laboratory meetings you will work on projects intended to illustrate particular concepts in computational chemistry and to challenge your problem solving abilities. Projects will span one or two weeks. A pre-lab reading may be assigned for each project. At the end of each project you will submit a Mathematica notebook. A detailed schedule can be found on the course website.
%
% --- THINGS I GRADE ---
%
\section{Things I Grade}
You and I will determine your progress in this laboratory using the scores derived from evaluating your Mathematica notebooks. No other items are evaluated and graded. 
%
% --- Project Reports ---
%
\subsection{Project Notebooks}
For \marginnote{-0.1in}{Each team submits one Mathematica notebook, and all members of the team receive the same score.} each laboratory project, you must complete a Mathematica notebook containing your work. It will include justifications for the work, clear setup of the work, well-organized conclusions, and explanations of results. Notebooks will be evaluated for clarity, presentation, and accuracy. Each notebook is evaluated on a 100-point scale, and all 
%
% --- COURSE LETTER GRADE ---
%
\section{Course Letter Grade}
Your \marginnote{-0.1in}{Evaluation Weights \\ Project Notebooks: 100\% } course score will be calculated as a weighted average of the scores you earn on evaluation of the project notebooks ($100\%$). 
%
% --- LETTER GRADE ---
%
